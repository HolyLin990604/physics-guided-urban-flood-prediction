...
flowchart TB
    ...
    H["Current Status<br/>Phase 44 Level 4+ replanning complete<br/>UrbanFlood24 full route<br/>Phase 45 indexing next<br/>Level 5 SWE/PINN frozen"]:::current
...
flowchart TD
    ...
    C["Strong Physics Boundary<br/>Level 4+ proxy diagnostics supported<br/>Level 5 SWE/PINN not supported<br/>Phases 26 + 30-44"]:::boundary
    ...
    E["Current Decision<br/>UrbanFlood24 full Level 4+ replanning<br/>no training or Level 5 claim<br/>Phase 44 complete"]:::current
    F["Next Research Direction<br/>full dataset indexing<br/>adapter and dataloader smoke tests<br/>then Level 4+ proxy modeling"]:::current
...
- **Phase 45-50 roadmap: Phase 45 full dataset indexing and lightweight adapter; Phase 46 dataloader smoke test and downsample/tiling feasibility; Phase 47 full dataset downsample baseline training; Phase 48 full dataset reliability and physical proxy diagnostics; Phase 49 full dataset warning framework extension; Phase 50 optional 256x256 / tile / multiscale refinement**
...
- prioritize Phase 45 full dataset indexing and lightweight adapter work next
- run training only after Phase 45 indexing and Phase 46 dataloader smoke tests establish a viable data path
- follow the compact Phase 45-50 route: Phase 45 full dataset indexing and lightweight adapter; Phase 46 dataloader smoke test and downsample/tiling feasibility; Phase 47 full dataset downsample baseline training; Phase 48 full dataset reliability and physical proxy diagnostics; Phase 49 full dataset warning framework extension; Phase 50 optional 256x256 / tile / multiscale refinement
