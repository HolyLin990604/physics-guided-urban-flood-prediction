...
flowchart TB
    ...
    H["Current Status<br/>Phase 45 indexing complete<br/>UrbanFlood24 full route<br/>Phase 46 dataloader smoke next<br/>Level 5 SWE/PINN frozen"]:::current
...
flowchart TD
    ...
    C["Strong Physics Boundary<br/>Level 4+ proxy diagnostics supported<br/>Level 5 SWE/PINN not supported<br/>Phases 26 + 30-45"]:::boundary
    ...
    E["Current Decision<br/>UrbanFlood24 full index ready<br/>no training or Level 5 claim<br/>Phase 45 complete"]:::current
    F["Next Research Direction<br/>dataloader smoke tests<br/>downsample/tiling feasibility<br/>then gated Level 4+ proxy modeling"]:::current
...
- **Phase 46 must smoke-test dataloader handling for variable flood sequence lengths and rainfall lengths, plus downsample/tiling feasibility**
- **Phase 47 training remains blocked until Phase 46 passes**
- **Phase 45-50 roadmap: Phase 45 full dataset indexing and lightweight adapter complete; Phase 46 dataloader smoke test and downsample/tiling feasibility; Phase 47 full dataset downsample baseline training only if Phase 46 passes; Phase 48 full dataset reliability and physical proxy diagnostics; Phase 49 full dataset warning framework extension; Phase 50 optional 256x256 / tile / multiscale refinement**
...
- prioritize Phase 46 dataloader smoke test and downsample/tiling feasibility next
- keep Phase 47 training blocked until Phase 46 dataloader smoke tests establish a viable data path
