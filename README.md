...
flowchart TB
    ...
    H["Current Status<br/>Phase 42 export contract complete<br/>Level 4+ proxy diagnostics only<br/>dataset inspection / hydrodynamic export needed<br/>Level 5 SWE/PINN not supported"]:::current
...
flowchart TD
    ...
    C["Strong Physics Boundary<br/>Level 4+ proxy diagnostics supported<br/>Level 5 SWE/PINN not supported<br/>Phases 26 + 30-42"]:::boundary
    ...
    E["Current Decision<br/>export_contract_ready_for_dataset_inspection<br/>training_authorized = false<br/>Phase 42 complete"]:::current
    F["Next Research Direction<br/>UrbanFlood24 full inspection<br/>ICM / MIKE+ / equivalent export<br/>no training or SWE implementation"]:::current
...
- prioritize UrbanFlood24 full dataset inspection and/or request/export of fields from InfoWorks ICM, MIKE+, or an equivalent hydrodynamic source next
