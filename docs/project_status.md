...
- make Phase 52 the only authorized next training phase, limited to controlled `128 x 128` `seed42` longer-run training with a recommended 40-epoch cap and direct comparison against Phase 47
- keep seed replication, `seed123` / `seed202`, `256 x 256`, tile, multiscale, full `500 x 500`, sweeps, new loss redesign, and model/loss/config architecture changes deferred
