...
- read Phase 40 as failed-pilot design review and next-constraint decision: proxy-loss redesign is paused, `training_authorized = false`, and the next technical work should be a no-training SWE data readiness audit
