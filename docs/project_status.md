...
- use Phase 46 to plan a controlled Phase 47 full dataset downsample baseline, likely starting with `128 x 128`
- keep training unauthorized until a reviewed Phase 47 baseline plan is created
