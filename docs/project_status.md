...
- use Phase 42 to guide UrbanFlood24 full dataset inspection and/or InfoWorks ICM, MIKE+, or equivalent hydrodynamic export requests, not training, SWE loss implementation, SWE residual implementation, PINN implementation, strict conservation, full mass conservation, hydrodynamic closure, or Level 5 claims
